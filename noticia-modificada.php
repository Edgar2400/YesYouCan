...
<!-- Cuerpo -->
	<h3 class="w3l_head w3l_head1">Noticia modificada</h3>
	<br><br>
<center>
	<?php
		$id=$_POST["id"];
		...
		mysqli_query($conexion, "UPDATE noticias SET tituloNoticia='$tituloNoticia', detallesNoticia='$detallesNoticia' WHERE id='$id'");

		echo "<h3 class='w3l_head w3l_head1'>Noticia actualizada con éxito</h3>";
		echo "<br><br>";
